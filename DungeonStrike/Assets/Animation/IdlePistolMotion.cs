...
{
    /// <summary>
    /// Idle state with a pistol.
    /// </summary>
    [MotionName("Idle - Pistol")]
    public class IdlePistolMotion : MotionControllerMotion
    {
        /// <summary>
        /// Trigger values for the motion
        /// </summary>
        public const int PHASE_UNKNOWN = 0;
        public const int PHASE_START = 1055971000;
...
#if UNITY_EDITOR
            if (_EditorAnimatorSMName.Length == 0) { _EditorAnimatorSMName = "IdlePistolMotion-SM"; }
#endif
        }
        ...
        public IdlePistolMotion(MotionController rController)
            : base(rController)
        {
            _Priority = 0;
            _ActionAlias = "ActivateRotation";
        ...
        public override void LoadAnimatorData()
        {
            ...
            /// </summary>
            TRANS_EntryState_IdlePose = mMotionController.AddAnimatorName("Entry -> Base Layer.IdlePistolMotion-SM.IdlePose");
            TRANS_AnyState_IdlePose = mMotionController.AddAnimatorName("AnyState -> Base Layer.IdlePistolMotion-SM.IdlePose");
            STATE_IdlePose = mMotionController.AddAnimatorName("Base Layer.IdlePistolMotion-SM.IdlePose");
        }
        ...
        protected override void CreateStateMachine()
        {
            ...
            UnityEditor.Animations.AnimatorState lIdlePose = lMotionStateMachine.AddState("IdlePose", new Vector3(288, 24, 0));
        ...
        public override void OnSettingsGUI()
        {
            ...
            mIdle = CreateAnimationField("IdlePose", "Assets/ThirdParty/PistolAnimsetPro/Animations/PistolAnimsetPro.fbx/Pistol_Idle.anim", "Idle", mIdle);
