...
{
    /// <summary>
    /// Idle state without a weapon.
    /// </summary>
    [MotionName("Idle - No Weapon")]
    public class IdleNoWeaponMotion : MotionControllerMotion
    {
        /// <summary>
        /// Trigger values for the motion
        /// </summary>
        public const int PHASE_UNKNOWN = 0;
        public const int PHASE_START = 1055969000;
...
#if UNITY_EDITOR
            if (_EditorAnimatorSMName.Length == 0) { _EditorAnimatorSMName = "IdleNoWeaponMotion-SM"; }
#endif
        }
        ...
        public IdleNoWeaponMotion(MotionController rController)
            : base(rController)
        {
            _Priority = 0;
            _ActionAlias = "ActivateRotation";
        ...
        public override void LoadAnimatorData()
        {
            ...
            /// </summary>
            TRANS_EntryState_IdlePose = mMotionController.AddAnimatorName("Entry -> Base Layer.IdleNoWeaponMotion-SM.IdlePose");
            TRANS_AnyState_IdlePose = mMotionController.AddAnimatorName("AnyState -> Base Layer.IdleNoWeaponMotion-SM.IdlePose");
            STATE_IdlePose = mMotionController.AddAnimatorName("Base Layer.IdleNoWeaponMotion-SM.IdlePose");
        }
