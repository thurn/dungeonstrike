...
{
    /// <summary>
    /// Idle state with a rifle.
    /// </summary>
    [MotionName("Idle - Rifle")]
    public class IdleRifleMotion : MotionControllerMotion
    {
        /// <summary>
        /// Trigger values for the motion
        /// </summary>
        public const int PHASE_UNKNOWN = 0;
        public const int PHASE_START = 1055970000;
...
#if UNITY_EDITOR
            if (_EditorAnimatorSMName.Length == 0) { _EditorAnimatorSMName = "IdleRifleMotion-SM"; }
#endif
        }
        ...
        public IdleRifleMotion(MotionController rController)
            : base(rController)
        {
            _Priority = 0;
            _ActionAlias = "ActivateRotation";
        ...
        public override void LoadAnimatorData()
        {
            ...
            /// </summary>
            TRANS_EntryState_IdlePose = mMotionController.AddAnimatorName("Entry -> Base Layer.IdleRifleMotion-SM.IdlePose");
            TRANS_AnyState_IdlePose = mMotionController.AddAnimatorName("AnyState -> Base Layer.IdleRifleMotion-SM.IdlePose");
            STATE_IdlePose = mMotionController.AddAnimatorName("Base Layer.IdleRifleMotion-SM.IdlePose");
        }
        ...
        public override void OnSettingsGUI()
        {
            ...
            mIdle = CreateAnimationField("IdlePose", "Assets/ThirdParty/RifleAnimsetPro/Animations/RifleAnimsetPro.fbx/Rifle_Idle.anim", "Idle", mIdle);
